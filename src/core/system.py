...
class System(_System):
    ...
    def evaluate(self, func):
        '''evaluate(func: NumericFunction)
        Evaluate the given numerical function within this system.

        The next example uses the matrix ``Phi`` generated by the example ``four_bar.py``

        :Example:

        >>> _, func = matrix_list_optimize(Phi)
        >>> func
        Numeric function
        >>> evaluate(func)
        ...
        .. seealso:: :func:`matrix_list_optimize`

        :param func: Must be the numerical function to evaluate
        :type func: NumericFunction
